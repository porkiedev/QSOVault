...
use crate::QSOVault;
use crate::modules::database_interface;
                    ...
                    if let Ok(db) = &mut app.db {
                        ...
                        for contact in &contacts {
                            ...
                            body.row(18.0, |mut row| {
                                ...
                                row.col(|ui| {
                                    let mut temp_thingy = contact.id.as_ref().unwrap();
                                    ui.label(temp_thingy.id.to_string());
                                });
                                row.col(|ui| {
                                ...
                                row.col(|ui| {
                                    if let Some(val) = &contact.frequency {
